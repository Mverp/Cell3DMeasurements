...
/**
 * Allow the user to set which of the measurements that are available in the Feature Extractor are going to be active. The choices are being stored as preferences via the Prefs class and can be
 * retrieved as such. This class also provides the methods to do this.
 *
...
public class Measurement_Selector implements PlugIn
{
	 ...
	 *
	 * @param aMeasurementName The name of the measurement
	 *
	 ...
	 *
	 * @param aMeasurementName The name of the measurement
	 * @param aChoice          The boolean choice to set
	 */
	 ...
	 *
	 * @param aNames  The list of measurement names to add. The order is very important and should coincide with the retrieval order after the dialog is closed!
	 * @param aDialog The dialog to which the measurements check boxes are added
	 */
	 ...
	 *
	 * @param aMeasurementNames The list of names of the next measurement choices. The order is very important and should coincide with the order in which the names were added to the dialog!
	 * @param aDialog           The dialog to retrieve the choices from
	 */
